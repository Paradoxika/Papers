...
and the number of axioms (i.e. \emph{unsat core} size) have been measured. Raw data of the experiment can be downloaded from {\skeptik}'s repository\footnote{\burl{https://github.com/Paradoxika/Papers/blob/\\4223ab402418e6cc49b2197ed975cf04fb2ceba9/LUniv/all-final.csv?raw=true}}.
...
compression,
%\footnote{\url{http://www.logic.at/people/bruno/MediaWiki/index.php/Amadeus\_Vienna-Nancy\_Joint\_Project\_on\_Proof\_Compression}}
