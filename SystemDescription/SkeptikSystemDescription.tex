...
However, as shown in \cite{gilbert1980pebbling}, finding the optimal solution (TODO: finding solutions is not a decision problem. Therefore, it is an abuse of language to say that it is PSPACE. This has to be improved.) is PSPACE-complete and therefore not a feasible approach for this program. Greedy heuristics are used for finding a good, though not optimal, node ordering.
