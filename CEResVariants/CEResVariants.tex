...
\input{CEResVariants-Intro}
\input{CEResVariants-CERes}
\input{CEResVariants-Redundancy}
\input{CEResVariants-Swapped}
\input{CEResVariants-Definitional}
\input{CEResVariants-Combined}
\input{CEResVariants-QuantifierFree}
\input{CEResVariants-Conclusion}

\appendix

%\input{CEResVariants-Appendix-InferencePermutation}
%\input{CEResVariants-Appendix-CorrespondenceLemma}
