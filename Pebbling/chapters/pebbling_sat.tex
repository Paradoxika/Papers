...
Pebbling is a graph problem and many graph problems can be encoded as SAT problems and, at least in principle, solved by running a SAT solver \cite{ToDo: Handbook of Satisifiability?}. \marginpar{add citation here.} 
