...
\begin{figure}
\centering
    \subfloat{{\includegraphics[scale=0.5]{images/cumulative_res_nodes_no_subs_top100.pdf}
}}%
    \subfloat{{\includegraphics[scale=0.5]{images/compress_length_no_sub_vs_length_all_proofs.pdf} }}%
