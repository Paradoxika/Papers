...
\centering
    ...
    \subfloat[Overall average compression]{{\includegraphics[scale=0.5]{images/compress_ratio_res_vs_proof_length_all_proofs.pdf} }}\hfill
    \subfloat[Number of proofs of each length compressed]{{\includegraphics[scale=0.5]{images/num_compressed_stacked.pdf}}}
    \subfloat[Compressed length against input length]{{\includegraphics[scale=0.5]{images/compress_length_no_sub_vs_length_all_proofs.pdf} }}\hfill
