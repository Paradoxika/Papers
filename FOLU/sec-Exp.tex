...
\begin{figure}
\centering
    \subfloat[label 1]{{\includegraphics[scale=0.5]{images/compress_ratio_res_vs_proof_length.pdf}
}}%
    \subfloat[label 2]{{\includegraphics[scale=0.5]{images/compress_ratio_res_vs_proof_length_all_proofs.pdf} }}%
\end{figure}
...
\begin{figure}
\centering
    \subfloat[label 1]{{\includegraphics[scale=0.5]{images/num_compressed_stacked.pdf}
}}%
    \subfloat[label 2]{{\includegraphics[scale=0.5]{images/cumulative_res_nodes_no_subs.pdf} }}%
\end{figure}
...
\begin{figure}
\centering
    \subfloat[label 1]{{\includegraphics[scale=0.5]{images/cumulative_res_nodes_no_subs_top100.pdf}
}}%
    \subfloat[label 2]{{\includegraphics[scale=0.5]{images/compress_length_no_sub_vs_length_all_proofs.pdf} }}%
\end{figure}
