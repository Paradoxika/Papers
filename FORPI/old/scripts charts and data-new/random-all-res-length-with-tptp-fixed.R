...
alldataRPItptp = read.csv("D:/Research Scripts/GSoC14/August 2017b - Charts - R/cade-forpi.txt")
...
#get LU-only data
alldataLUtptp = read.csv("D:/Research Scripts/GSoC14/August 2017b - Charts - R/cade-folu.txt")
...
#get LURPI-only data
alldataLURPItptp = read.csv("D:/Research Scripts/GSoC14/August 2017b - Charts - R/cade-folurpi.txt")
...
#get RPILU-only data
alldataRPILUtptp = read.csv("D:/Research Scripts/GSoC14/August 2017b - Charts - R/cade-forpilu.txt")
...
plot(lengthRPI,compressedLengthFinalRPI ,  xlim=c(0,axisLimit), ylim=c(0,axisLimit ),axes=FALSE, xlab="Proof Length (Resolutions)", ylab="Compressed Length (Resolutions)",yaxs="i", xaxs="i", pch=c(1), col=c("orange"))
...
legend("topleft",c("FORPI(p)", "GFOLU(p)", "FORPI(GFOLU(p))", "GFOLU(FORPI(p))"), pch=c(1,4,2,3), col=c("orange","red", "blue", "green"), bty="n")


points(lurpiPointstptp,col="green",pch=3)
points(rpiPointstptp,col="orange",pch=1) 
...
points(rpiPointstptpScaled,col="orange",pch=1) 
