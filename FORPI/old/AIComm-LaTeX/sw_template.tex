...
\begin{review}{editor}
\author{\fnms{First} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\end{review}
\begin{review}{solicited}
\author{\fnms{Second} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\end{review}
\begin{review}{open}
\author{\fnms{Third} \snm{Reviewer}\address{\institution{University or Company name}, \cny{Country}}}
\end{review}
