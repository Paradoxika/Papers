...
#RPI-LU
sizeRPILU = "luNumRes" #or luNumRes
cSizeRPILU = "luNumResCompressed" #or "luNumResCompressed"
...
pdf('random-forpi-cumulative-res-nodes-all.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))

plot(rpiLine[,1],rpiLine[,2],type="n",  xlim=c(0,rpiXaxis), ylim=c(0,rpiYaxis ),axes=FALSE, xlab="Number of Proofs", ylab="Number of Resolution Nodes (x10^4)",yaxs="i", xaxs="i")
...
pdf('random-folu-cumulative-res-nodes-all.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))

plot(luLine[,1],luLine[,2],type="n",  xlim=c(0,luXaxis), ylim=c(0,luYaxis ),axes=FALSE, xlab="Number of Proofs", ylab="Number of Resolution Nodes (x10^4)",yaxs="i", xaxs="i")
...
pdf('random-folurpi-cumulative-res-nodes-all.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))

plot(lurpiLine[,1],lurpiLine[,2],type="n",  xlim=c(0,lurpiXaxis), ylim=c(0,lurpiYaxis ),axes=FALSE, xlab="Number of Proofs", ylab="Number of Resolution Nodes (x10^4)",yaxs="i", xaxs="i")
...
pdf('random-forpilu-cumulative-res-nodes-all.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))

plot(rpiluLine[,1],rpiluLine[,2],type="n",  xlim=c(0,rpiluXaxis), ylim=c(0,rpiluYaxis ),axes=FALSE, xlab="Number of Proofs", ylab="Number of Resolution Nodes (x10^4)",yaxs="i", xaxs="i")
...
pdf('random-all-cumulative-res-nodes-all.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))

plot(rpiluLine[,1],rpiluLine[,2],type="n",  xlim=c(0,allXaxis), ylim=c(0,allYaxis ),axes=FALSE, xlab="Number of Proofs", ylab="Number of Resolution Nodes (x10^4)",yaxs="i", xaxs="i")
