...
length(compressedLengthFinalLU)
length(cleanDataPoints)
cleanDataPoints[,2]
...
pdf('random-folu-length-vs-compressed-length.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))

plot(lengthLU,compressedLengthFinalLU ,  xlim=c(0,axisLimit), ylim=c(0,axisLimit ),axes=FALSE, xlab="Proof Length", ylab="Compressed Length",yaxs="i", xaxs="i")
