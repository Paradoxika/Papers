...
pdf('random-forpi-cumulative-nodes-diff.pdf', height=5, width=5)
...
pdf('random-folu-cumulative-nodes-diff.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
...
pdf('random-folurpi-cumulative-nodes-diff.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
...
pdf('random-forpilu-cumulative-nodes-diff.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
...
pdf('random-all-cumulative-nodes-diff.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
