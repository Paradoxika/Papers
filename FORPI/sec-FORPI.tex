...
Note that, in order to reduce notation clutter in the pseudocodes, we slightly abuse notation and identify proofs, their root nodes and the clauses stored in their root nodes.
