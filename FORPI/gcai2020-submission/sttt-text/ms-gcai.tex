...
\author{Jan Gorzny\inst{1}\thanks{J. Gorzny and E. Postan were Supported by the Google Summer of Code 2014 and Google Summer of Code 2016 programs.}  \and Ezequiel Postan\inst{2}$^*$ \and Bruno Woltzenlogel Paleo\inst{3}\thanks{Bruno ist Stipendiat der \"{O}sterreichischen Akademie der Wissenschaft (APART) an der TU-Wien}}
