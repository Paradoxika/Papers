...
%$\eta_1$ be a node with safe literals $\mathcal{S}(\eta)$ such that there exists nodes $\eta_2$ and $\eta$ and resolved literal $\ell'$ such that $\eta_1 \xrightarrow[\sigma']{\{\ell'\} } \eta$ and $\eta_2 \xrightarrow[\sigma'']{\{\dual{\ell'}\} } \eta$.
