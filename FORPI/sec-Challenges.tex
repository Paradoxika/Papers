...
in a proof $\psi$. $\eta$ is said to satisfy the \emph{regularization unifiability property} in $\psi$ if there exists a unifier $\sigma$ such that $\sigma\eta_1 \subseteq \phi$.
\end{definition}
