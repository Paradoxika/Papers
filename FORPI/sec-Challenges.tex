...
\section{First-Order Conditions}\label{sec:Challenges}
...
$\eta_3$ &  $\{R(w),\lnot P(w)\}$ & $\emptyset$  & $\emptyset$\\ \hline 
$\eta_4$ &  $\{\lnot R(w),\lnot P(w)\}$& $\emptyset$& $\emptyset$ \\ \hline 
$\eta_5$ &  $\{Q(z),\lnot R(w), \lnot P(w)\}$ & $\emptyset$ & $\emptyset$\\ \hline 
$\eta_6$ &  $\{\lnot P(w), \lnot Q(z), \lnot R(w) \}$ & $\{P(u),P(y)\}$& $\{P(u)\}$\\ \hline 
$\eta_7$ &  $\{P(y), \lnot P(w), \lnot Q(z), \lnot R(w) \}$ & $\emptyset$ & $\emptyset$ \\ \hline 
$\eta_8$ &   $\{\lnot P(y), \lnot P(w), \lnot Q(z), \lnot R(w) \}$ & $\emptyset$ & $\emptyset$\\ \hline 
\end{tabular}
\hfill
...
\item $\ell=\lnot P(y)$: $\ell^\dagger = \lnot P(w)$ which is unifiable with $\dual{\ell}^\dagger=P(u)$
\end{itemize}
\end{example}
