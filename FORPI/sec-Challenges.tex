...
$\eta_2$ is marked \texttt{deleted}
in a proof $\psi$. $\eta$ is said to satisfy the \emph{regularization unifiability property} in $\psi$ if there exists a substitution $\sigma$ such that $\sigma\eta_1 \subseteq \phi$.
\end{definition}
