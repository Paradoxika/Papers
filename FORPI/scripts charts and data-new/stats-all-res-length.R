...
setwd("D:/Git Repositories/Papers/FORPI/scripts charts and data-new")

#Get the tptp data
#get RPI-only data
alldataRPI = read.csv("D:/Git Repositories/Papers/FORPI/scripts charts and data-new/cade-forpi.txt")
#get RPILU-only data
alldataRPILU = read.csv("D:/Git Repositories/Papers/FORPI/scripts charts and data-new/cade-forpilu.txt")
#get LURPI-only data
alldataLURPI = read.csv("D:/Git Repositories/Papers/FORPI/scripts charts and data-new/cade-folurpi.txt")
#get LU-only data
alldataLU = read.csv("D:/Git Repositories/Papers/FORPI/scripts charts and data-new/cade-folu.txt")


#get all data
alldata = read.csv("D:/Git Repositories/Papers/FORPI/scripts charts and data-new/random-all-data-aug22.txt")
...
#USE this value to calculate percentages for # of removed nodes - this is the amount of random nodes, originally.
numberOfNodesRPI 
numberOfNodesLU 
numberOfNodesRPILU 
numberOfNodesLURPI 
...
#USE THESE VALUES FOR #of Removed Nodes - Random column
...
#USE THESE VALUES FOR #of Removed Nodes - Random column - percentages
rpiCompressRatio 
luCompressRatio
rpiluCompressRatio 
lurpiCompressRatio 
...
#USE THESE VALUES for #of proofs compressed table
rpiCompressedCount
luCompressedCount
...
#USE THESE VALUES for #of proofs compressed table - compressed
