...
\noindent
The notion of \emph{strongly regularizable} can be thought of as a \emph{sufficient} condition, and the following is proved in \cite{longversion}, which also discusses a conjectured weaker condition. % is also discussed in \cite{longversion}.
