...
pdf('tptp-forpi-cumulative-rnodes-diff.pdf', height=5, width=5)
...
pdf('tptp-folu-cumulative-rnodes-diff.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
...
pdf('tptp-folurpi-cumulative-rnodes-diff.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
...
pdf('tptp-forpilu-cumulative-rnodes-diff.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
...
pdf('tptp-all-cumulative-rnodes-diff.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
