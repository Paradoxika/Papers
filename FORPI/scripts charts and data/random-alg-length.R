...
pdf('random-alg-length.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))

plot(compressedLengthFinalRPILU,compressedLengthFinalLURPI ,  xlim=c(0,axisLimit), ylim=c(0,axisLimit ),axes=FALSE, xlab="Compressed Length (FORPI(GFOLU(p)))", ylab="Compressed Length (GFOLU(FORPI(p)))",yaxs="i", xaxs="i")
