...
#Get the data
#LURPI
sizeLURPI = "lurpiNumRes" #or rpiNumRes
cSizeLURPI = "lurpiNumResCompressed" #or "rpiNumResCompressed"
...
pdf('random-folurpi-res-length-vs-compressed-res-length.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))

plot(lengthLURPI,compressedLengthFinalLURPI ,  xlim=c(0,axisLimit), ylim=c(0,axisLimit ),axes=FALSE, xlab="Proof Length (Resolutions)", ylab="Compressed Length (Resolutions)",yaxs="i", xaxs="i")
