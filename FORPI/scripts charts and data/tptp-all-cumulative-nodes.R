...
pdf('tptp-forpi-cumulative-nodes-all.pdf', height=5, width=5)
...
pdf('tptp-folu-cumulative-nodes-all.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
...
pdf('tptp-folurpi-cumulative-nodes-all.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
...
pdf('tptp-forpilu-cumulative-nodes-all.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
...
pdf('tptp-all-cumulative-nodes-all.pdf', height=5, width=5)
par(mar=c(5.1,4.1,1,2.1))
