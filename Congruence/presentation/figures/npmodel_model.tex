...
\alt<6,14>{\draw [-,line width = 2pt,red] (c1) to (t1x1);}{\draw [-] (c1) to (t1x1);}
\draw [-] (c1) to (t1x2);
\draw [-] (c1) to (t1x3);
...
\alt<6,14>{\draw [-,line width = 2pt,red] (c1p) to (t11);}{\draw [-] (c1p) to (t11);}
\draw [-] (c1p) to (t12);
\draw [-] (c1p) to (t13);

\node[right = .3cm of c1p](c2){$c_2\phantom{'}$};
\alt<6,14>{\draw [-,line width = 2pt,red] (c1p) to (c2);}{\draw [-] (c1p) to (c2);}

\node[right=.25cm of c2, yshift=.8cm]  (t2x2) {$t_2(\hat{x}_2)$};
\node[right=.25cm of c2, yshift=-.8cm] (t2x3) {$t_2(\hat{x}_3)$};
\alt<6,14>{\draw [-,line width = 2pt,red] (c2) to (t2x2);}{\draw [-] (c2) to (t2x2);}
\draw [-] (c2) to (t2x3);
...
\draw [-] (c2p) to (t23);
\alt<6,14>{\draw [-,line width = 2pt,red] (c2p) to (t22);}{\draw [-] (c2p) to (t22);}

\node[right = .3cm of c2p](c3){$c_3\phantom{'}$};
\alt<6,14>{\draw [-,line width = 2pt,red] (c2p) to (c3);}{\draw [-] (c2p) to (c3);}


\node[right =.25cm of c3, yshift=.8cm] (t3x1) {$t_3(\hat{x}_1)$};
\node[right =.25cm of c3, yshift=-.8cm] (t3x3) {$t_3(\hat{x}_3)$};
\draw [-] (c3) to (t3x1);
\alt<6,14>{\draw [-,line width = 2pt,red] (t3x3) to (c3);}{\draw [-] (t3x3) to (c3);}
...
\draw [-] (c3p) to (t31);
\alt<6,14>{\draw [-,line width = 2pt,red] (c3p) to (t33);}{\draw [-] (c3p) to (t33);}
...
\alt<4-6,8-9,10-14>{\draw [-,line width = 2pt,red] (x1) to (t1);}{\draw [-] (x1) to (t1);}
\alt<11-13>{\draw [-,line width = 2pt,red] (x1) to (f1);}{\draw [-] (x1) to (f1);}

\node [right = of x2] (t2) {$\top_2$};
\node [left = of x2] (f2) {$\bot_2$};

\draw [-] (x2) to (t2);
\alt<4-6,8-14>{\draw [-,line width = 2pt,red] (x2) to (f2);}{\draw [-] (x2) to (f2);}

\node [right = of x3] (t3) {$\top_3$};
\node [left = of x3] (f3) {$\bot_3$};

\alt<8-9>{\draw [-,line width = 2pt,red] (x3) to (t3);}{\draw [-] (x3) to (t3);}
\alt<4-6,14>{\draw [-,line width = 2pt,red] (x3) to (f3);}{\draw [-] (x3) to (f3);}
