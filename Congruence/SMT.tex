...
Furthermore, $|E_{\mathcal{I}} \cup E_\mathcal{C}|$ and
...
\hat{c}_1 = \hat{c}'_{n+m}$ and $|E'| \leq 3n+4m-1$, where $\mathcal{C}'$ is
...
The equation $\hat{c}_1 = \hat{c}'_{n+m}$ is a consequence of the disjoint union
$E \cup E_{\mathcal{I}}$, which contains $3n + 4m - 1$ elements.

($\Leftarrow$)  An explanation of $\hat{c}_1 =
\hat{c}'_{n+m}$ has to contain $2(n + m)$ equations from $Clause_i$ ($i= 1\dots
