...
\author{Andreas Fellner\inst{1,2}
   ...
   \and Bruno Woltzenlogel Paleo\inst{2,5}\thanks{This work has been partially supported by the project ANR-13-IS02-0001 of the Agence Nationale de la Recherche, by the European Union Seventh Framework Programme under grant agreement no. 295261 (MEALS), by the STIC AmSud MISMT, by FWF S11407-N23 (RiSE/SHiNE), and by ERC Start Grant (279307: Graph Games).}
}
