...
This section presents {\SFOLowerUnits} (Algorithm \ref{algo:optSFOLU}), an single traversal first-order adaptation of {\LowerUnits}, which avoids
the quadratic complexity and the 
